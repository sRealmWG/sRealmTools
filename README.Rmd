...
<!-- badges: start -->
 [![CRAN status](https://www.r-pkg.org/badges/version/sRealmTools)](https://CRAN.R-project.org/package=sRealmTools)
...
The goal of sRealmTools is to offer simulation tools, in time, on top of mobsim
spatial simulations. These functions let you make the classic mobsim individuals
move and die.

## Installation

You can install the development version of sRealmTools from [GitHub](https://github.com/) with:
